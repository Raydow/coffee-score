...
import com.raydow.efit.config.jwt.JwtService;
import com.raydow.efit.domain.Token;
import com.raydow.efit.domain.TokenType;
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      ...
      if (jwtService.isTokenValid(refreshToken, user)) {
        ...
        var authResponse = AuthenticationResponseVO.builder()
